...
/*   Updated: 2023/10/04 18:53:13 by sperez-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strjoin( char const *s1, char const *s2 )
{
	...
	if (!s1 || !s2)
		return (0);
	final_str = (char *)ft_calloc(ft_strlen(s1) + ft_strlen(s2) + 1, sizeof(char));
	i = 0;
	j = 0;
	if (!final_str)
		return (0);
 ...
 * Return:
 *     final_str: the newly allocated string containing the extracted substring
